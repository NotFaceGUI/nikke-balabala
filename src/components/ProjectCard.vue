<template>
    <div class="card">
        <div class="role" :style="{ backgroundImage: 'url(/pic/' + selectNikkes.projectNikkes[0].img + '.png)' }">
        </div>
...
.card {
    ...
    color: black;
    box-shadow:
        0px 0.4px 2.4px -6px rgba(0, 0, 0, 0.192),
        0px 1.3px 7.1px -6px rgba(0, 0, 0, 0.259),
        0px 6px 9px -6px rgba(0, 0, 0, 0.31);
    margin: 6px 10px;
    border-radius: 5px;
...
.role {
    ...
    box-shadow: inset 0px 0px 16px 0px rgba(0, 0, 0, 0.274);
}
